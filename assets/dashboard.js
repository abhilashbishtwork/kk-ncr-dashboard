...
// Display-only: strips redundant city/brand-code prefixes some display
// names might still carry (kept from the Pune build, harmless no-op for
// NCR's already-clean display names). The underlying display_name (used
// for every data lookup: opsRows, store_hours, URL ?store=, alert
...
function renderStorePicker(stores, selected) {
  ...
  allOpt.value = '';
  allOpt.textContent = 'All 39 stores';
