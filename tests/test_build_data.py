...
def test_run_writes_data_json_on_valid_pull(tmp_path, monkeypatch):
    ...
    online_rows = [{"order_date": "2026-08-17", "store_name": "DEL KK GK1 Online", "channel": "swiggy", "revenue": "100", "order_count": "1"}]
    launch_date_rows = [{"store_name": s, "launch_date": "2025-01-01"} for s in up_names()]
